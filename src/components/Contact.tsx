                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="animate-on-scroll opacity-0">
                            ...
                            <p className="text-lg text-neutral-700 leading-relaxed mb-8">
                                Let's discuss how our DSL expertise can
                                accelerate your software development and empower
                                your domain experts. Fill out the form, and
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-neutral-100">
                                {isSubmitted ? (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-neutral-700">
                                            Thank you for reaching out. We'll be
